...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    epoch_step = 0
    try:
        for i, (images, gts, skeleton) in enumerate(train_loader, start=1):
            optimizer.zero_grad()
            ...
            s0, s1, s2, s3, s4, s5 = model(images)
            # ---loss function-----------
            loss5 = structure_loss(s5, skeleton)
            ...
            if i % 100 == 0 or i == total_step or i == 1:  # i/400    100
...
def val(test_loader, model, epoch, save_path, writer):
    ...
    with torch.no_grad():
        ...
        # best_metric_dict = {}  # 初始化为空字典或包含默认值
        ...
        if epoch == 1:
            ...
            best_metric_dict = metrics_dict.copy()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batchsize', type=int, default=10, help='training batch size') #8
    ...
    parser.add_argument('--train_root', type=str, default='/home/xd508/zyx/COD/COD/TrainDataset/',
                        help='the training rgb images root')
    parser.add_argument('--val_root', type=str, default='/home/xd508/zyx/COD/COD/TestDataset/CAMO/',
    ...
    train_loader = get_loader(image_root=opt.train_root + 'Imgs/',
                              ...
                              edge_root=opt.train_root + 'Skeleton1/',
